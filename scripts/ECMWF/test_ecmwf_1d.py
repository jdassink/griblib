...
fid_profile = 'ecmwf20170529-06.dat'
...
# *************************************************************************
# reinterpolate onto HARMONIE grid
# *************************************************************************

lon_ = ds.longitude
lat_ = ds.latitude
new_lon = np.arange(lon_[0], lon_[-1], 0.0225)
new_lat = np.arange(lat_[-1], lat_[0], 0.0225)
...
dsi['z'].sel(hybrid=level).plot(cmap='terrain',
                               ax=ax,
